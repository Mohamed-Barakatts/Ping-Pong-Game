...
var Ball = {
    new: function (incrementedSpeed) {
        return {
            radius: 15, // Half of the original width/height
...
var Game = {
    ...
    update: function () {
        if (!this.over) {
            ...
            if (this.ball.x - this.ball.radius <= this.ai.x + this.ai.width &&
            ...
            if (this.ball.x <= this.ball.radius) Pong._resetTurn.call(this, this.ai, this.player);
            if (this.ball.x >= this.canvas.width - this.ball.radius) Pong._resetTurn.call(this, this.player, this.ai);
            if (this.ball.y <= this.ball.radius) this.ball.moveY = DIRECTION.DOWN;
            if (this.ball.y >= this.canvas.height - this.ball.radius) this.ball.moveY = DIRECTION.UP;
        }
    ...
    // Draw the background
    this.context.fillStyle = '#000000'; // Black background
    this.context.fillRect(
        0,
        0,
        this.canvas.width,
